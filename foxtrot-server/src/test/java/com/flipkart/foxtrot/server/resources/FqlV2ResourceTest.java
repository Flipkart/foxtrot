...
public class FqlV2ResourceTest extends FoxtrotResourceTest {
    ...
    public ResourceTestRule resources = ResourceTestRule.builder()
            .addResource(new FqlV2Resource(new FqlEngine(getTableMetadataManager(), getQueryStore(), getQueryExecutorFactory(), getMapper()),
                    new FqlStoreServiceImpl(getElasticsearchConnection(), getMapper()),
                    new AccessServiceImpl(new FoxtrotServerConfiguration(), new TableActionRequestVisitor()), new QueryConfig()))
