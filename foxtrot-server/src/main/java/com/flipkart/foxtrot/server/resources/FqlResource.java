...
import static com.flipkart.foxtrot.server.resources.FqlV2Resource.getValidRequestTags;
...
public class FqlResource {
    ...
    public StreamingOutput runFqlGet(@HeaderParam(SOURCE_TYPE) @DefaultValue("FQL") final SourceType sourceType,
                                     @HeaderParam(SERVICE_NAME) final String serviceName,
                                     @HeaderParam(SCRIPT_NAME) final String scriptName,
                                     @QueryParam("q") final String query) throws JsonProcessingException {
    ...
    public FlatRepresentation runFqlPost(@HeaderParam(SOURCE_TYPE) @DefaultValue("FQL") final SourceType sourceType,
                                         @HeaderParam(SERVICE_NAME) final String serviceName,
                                         @HeaderParam(SCRIPT_NAME) final String scriptName,
