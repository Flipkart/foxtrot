 ...
 */
function NonStackedLineTile() {
    this.object = "";
  }
  
  function getNonStackedLineFormValues() {
    var period = $("#non-stacked-line-time-unit").val();
    var timeframe = $(".non-stacked-line-timeframe").val();
    var chartField = $("#non-stacked-line-field").val();
    var uniqueKey = $("#non-stacked-line-uniquekey").val();
  ...
  function setNonStackedLineFormValues(object) {
    ...
    $("#non-stacked-line-timeframe").val(object.tileContext.timeframe);
    $("#non-stacked-line-field").val(parseInt(currentFieldList.findIndex(x => x.field == object.tileContext.stackedBarField)));
    $("#non-stacked-line-field").selectpicker('refresh');
  ...
  function clearNonStackedLineChartForm() {
    $('.nonStackedLineForm')[0].reset();
    $(".nonStackedLineForm").find('.selectpicker').selectpicker('refresh');
  }
...
// ------ Ends added today yesterday and daybefore yesterday-------------------------------
  ...
  NonStackedLineTile.prototype.render = function (d, isMultiSeries, originalData) {
