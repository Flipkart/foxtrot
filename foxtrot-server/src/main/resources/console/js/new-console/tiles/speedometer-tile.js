...
SpeedoMeterTile.prototype = new Tile();

SpeedoMeterTile.prototype.render = function (data, animate) {
    if (this.title) {
...
SpeedoMeterTile.prototype.getQuery = function () {
...
SpeedoMeterTile.prototype.isSetupDone = function () {
    return this.eventTypeFieldName && this.periodValue != 0 && this.periodUnit;
};

SpeedoMeterTile.prototype.configChanged = function () {
...
SpeedoMeterTile.prototype.loadFieldList = function () {
    var modal = $(this.setupModalName);
...
SpeedoMeterTile.prototype.populateSetupDialog = function () {
    var modal = $(this.setupModalName);
    if (!this.table) {
        this.table = this.tables.selectedTable.name;
    }
...
SpeedoMeterTile.prototype.registerSpecificData = function (representation) {
...
SpeedoMeterTile.prototype.loadSpecificData = function (representation) {
...
SpeedoMeterTile.prototype.isValueVisible = function (value) {
    return !this.uiFilteredValues || this.uiFilteredValues.hasOwnProperty(value);
}

SpeedoMeterTile.prototype.getUniqueValues = function () {
    var options = [];
...
SpeedoMeterTile.prototype.filterValues = function (values) {
