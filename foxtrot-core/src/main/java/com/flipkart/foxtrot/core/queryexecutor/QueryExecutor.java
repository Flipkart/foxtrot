...
public abstract class QueryExecutor {
    ...
    public <T extends ActionRequest> ActionResponse execute(T request) {
        ...
        try {
            ...
            log.error("Elapsed time in query execution: {}, request: {}, cache key: {}, Error: {}", elapsedTime,
                    JsonUtils.toJson(request), Objects.isNull(action)
                            ? "none"
                            : action.getRequestCacheKey(), e);
