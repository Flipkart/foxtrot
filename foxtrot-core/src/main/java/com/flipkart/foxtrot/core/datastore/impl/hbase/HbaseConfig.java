...
public class HbaseConfig {
    ...
    public String getHbaseZookeeperZnodeParent() {
        return hbaseZookeeperZnodeParent;
    }

    public void setHbaseZookeeperZnodeParent(String hbaseZookeeperZnodeParent) {
        this.hbaseZookeeperZnodeParent = hbaseZookeeperZnodeParent;
    }
