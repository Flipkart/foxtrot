 ...
 * Time: 12:23 AM
 */
public abstract class Action<ParameterType extends CachableResponseGenerator, ReturnType> implements Callable<String> {
    private ParameterType parameter;
    private Cache<ReturnType> cache;

    protected Action(ParameterType parameter) {
        this.parameter = parameter;
        this.cache = CacheUtils.getCacheFor(getName());
    }
