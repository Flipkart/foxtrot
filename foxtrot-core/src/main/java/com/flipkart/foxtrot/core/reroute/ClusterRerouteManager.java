...
public class ClusterRerouteManager {
    ...
    private boolean reallocateShard(ShardId shardId, String fromNode, String toNode) {
        MoveAllocationCommand moveAllocationCommand = new MoveAllocationCommand(shardId.getIndexName(), shardId.getId(),
                fromNode, toNode);
    ...
    private void createNodeNameVsNodeIdMap(BiMap<String, String> nodeNameVsNodeId) {
    ...
    private Deque<String> getVacantNodeId(int avgShardsPerNode, Map<String, NodeInfo> nodeIdVsNodeInfoMap) {
