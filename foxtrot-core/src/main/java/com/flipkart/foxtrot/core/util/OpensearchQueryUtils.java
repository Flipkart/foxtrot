...
import com.flipkart.foxtrot.core.querystore.query.OpenSearchQueryGenerator;
...
public class OpensearchQueryUtils {
    ...
    public static QueryBuilder translateFilter(ActionRequest request, List<Filter> extraFilters) {
        val filters = (null == extraFilters || extraFilters.isEmpty())
                ...
                .addAll(extraFilters)
                .build();
        return new OpenSearchQueryGenerator().genFilter(filters);
    }
}
