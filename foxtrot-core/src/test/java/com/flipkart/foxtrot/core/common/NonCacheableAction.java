...
import com.flipkart.foxtrot.core.querystore.actions.Operation;
 ...
 */
@VisibleForTesting
@AnalyticsProvider(opcode = Operation.testNoCache, request = NonCacheableActionRequest.class, response = NonCacheableActionResponse.class, cacheable = false)
