...
r = requests.get("http://prd-esfoxtrot601.phonepe.nm1:9200/consoles_v2/_search/?size=1000")
...
URL = "http://prd-esfoxtrot601.phonepe.nm1:9200/*"
...
for hit in data:
    ...
    URL = "http://prd-esfoxtrot601.phonepe.nm1:9200/consoles_v2/"
